...
The study utilized RNA-seq data from 553 samples, Reverse Phase Protein Array (RPPA) data, and machine learning algorithms to identify 1224 differentially expressed genes (DEGs) between normal and tumor samples. Gene set enrichment analysis (GSEA) revealed significant associations with biological processes such as serine-type endopeptidase activity regulation and pathways linked to cancer growth and metastasis.
